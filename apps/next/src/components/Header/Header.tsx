...
export default function Header() {
  return (
    <header className='bg-[#373B53] h-[72px] w-full flex justify-between lg:fixed lg:left-0 lg:flex-col lg:h-screen lg:w-[103px] lg:rounded-tr-[20px] lg:rounded-br-[20px] z-50'>
