...
export default function InvoiceDetails({
  ...
  return (
    <div className='bg-white dark:bg-[#1E2139] rounded-lg sm:mt-6'>
      <div className='mt-4 p-6 sm:px-12 sm:py-[3.125rem] sm:grid sm:grid-cols-2'>
        <div className='mt-[-0.1875rem] sm:mt-[0.0625rem]'>
          <p className='text-[0.9375rem] dark:text-white tracking-[-0.015rem] font-bold'>
            <span className='text-[#7E88C3]'>#</span>
            {invoice.id}
          </p>
          <p className='text-[0.8125rem] text-[#7E88C3] dark:text-[#DFE3FA] mt-[-0.0625rem] sm:mt-[0.3125rem]'>
        ...
        >
          <div id='left-grid'>
            <div className='mt-[0.1875rem]'>
              <p className='text-[0.8125rem] text-[#7E88C3] dark:text-[#DFE3FA] tracking-[-0.00625rem] font-medium'>
                Invoice Date
              </p>
              <p className='text-[0.9375rem] dark:text-white font-bold tracking-[-0.015625rem] mt-[0.625rem]'>
          ...
          <div id='right-grid' className='sm:pl-[2.375rem]'>
            <p className='text-[0.8125rem] text-[#7E88C3] dark:text-[#DFE3FA] tracking-[-0.00625rem] mt-[0.1875rem]'>
              Bill To
            </p>
            <p className='text-[0.9375rem] dark:text-white font-bold mt-[0.625rem] tracking-[-0.015625rem]'>
              {invoice.buyer.name}
            </p>
        ...
        >
          ...
          <p className='text-[0.9375rem] dark:text-white tracking-[-0.015625rem] font-bold'>
            {invoice.contact}
          </p>
        </div>
