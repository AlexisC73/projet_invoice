...
export default function InvoiceLi({ invoice }: { invoice: Invoice['data'] }) {
  return (
    <li>
      <Link
        href={`/invoice/${invoice.id}`}
        className='grid grid-cols-2 bg-white p-6 rounded-lg sm:flex sm:items-center sm:py-[1rem] sm:px-8 sm:gap-10 sm:relative'
      >
