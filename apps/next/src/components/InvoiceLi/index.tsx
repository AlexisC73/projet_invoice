...
export default function InvoiceLi({ invoiceLiData }: InvoiceLiProps) {
  ...
  return (
    <li>
      ...
      >
        <p className='text-[0.9375rem] w-[2.5rem] dark:text-white tracking-[-0.015625rem] font-bold mt-[-0.1875rem] sm:mt-[0.1875rem] sm:order-1'>
          <span className='text-[#7E88C3]'>#</span>
          {shortId}
        </p>
        <p className='text-[#858BB2] dark:text-white text-[0.8125rem] text-right mt-[-0.0625rem] sm:mt-[0.25rem] sm:flex-1 sm:text-left sm:order-3'>
          {buyerName}
        </p>
        <p className='mt-[1.1875rem] w-[7.5rem] text-[#7E88C3] dark:text-[#DFE3FA] text-[0.8125rem] sm:mt-[0.25rem] sm:order-2'>
