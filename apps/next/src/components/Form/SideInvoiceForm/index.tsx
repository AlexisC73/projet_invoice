...
export default function SideInvoiceForm({
  ...
  return (
    <div className='absolute xl:fixed top-[4.5rem] sm:top-0 left-0 right-0 bg-white dark:bg-[#141625] w-full sm:w-4/5 sm:min-w-[40rem] xl:w-[45rem] xl:pt-[2.0625rem] xl:pl-[9.875rem] sm:pl-[1.875rem] sm:pt-[2.125rem] sm:pr-[1.125rem] sm:h-screen flex flex-col rounded-br-[1.25rem] rounded-tr-[1.25rem]'>
