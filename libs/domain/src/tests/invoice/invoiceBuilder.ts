...
export const addressBuilder = ({
  ...
  return {
    withStreet: (street: string | undefined) =>
      addressBuilder({ ...props, street }),
    withCity: (city: string | undefined) => addressBuilder({ ...props, city }),
    withZip: (zip: string | undefined) => addressBuilder({ ...props, zip }),
    withCountry: (country: string | undefined) =>
